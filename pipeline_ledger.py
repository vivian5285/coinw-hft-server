...
def blank_pipeline(symbol: str = "", exchange: str = "coinw") -> Dict[str, Any]:
    return {
        "schema": "pipeline_v1",
        "exchange": str(exchange or "coinw"),
    ...
    def sync_position(
        ...
        *,
        ...
        with self._lock:
            ...
            if position_id:
                self.data["position_id"] = str(position_id)
...
def get_pipeline(symbol: str, exchange: str = "coinw") -> PipelineLedger:
