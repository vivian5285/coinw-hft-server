...
class ReentryProfile:
    ...
    def __init__(self, symbol: str):
        ...
        self.reentry_windows: Dict[str, int] = {
            ...
            "XAU": 3,   # 3×45m = 2.25h
            "BNB": 2,
            # 2026-09-13更正：以下三个品种2026-09-12新增时注释误写"150m周期"
            # (沿用了旧的假设)，当天晚些时候"三次校准"已经把真实TV周期
            # 定为OPENAI=120m/SNDK=75m/XPD=45m(见breath_profiles.py对应
            # 品种校准注释)，这里只是补正注释，数值本来就跟品种无关
            # (get_reentry_window对未登记品种默认回退2，加不加没有行为
            # 差异，纯粹保持"每个真实接线品种都显式登记"的一贯做法)。
            "OPENAI": 2,  # 2026-09-13更正：真实TV周期已从120分钟改成45分钟
            "SNDK": 2,    # 真实TV周期75分钟
            "XPD": 2,     # 真实TV周期45分钟
            "XPT": 2,     # 2026-09-13新增，真实TV周期45分钟，跟XPD同族同窗口
            "XRP": 2,     # 2026-09-13新增，真实TV周期45分钟
            "SOL": 2,     # 2026-09-13新增，真实TV周期45分钟
            "MU": 2,      # 2026-09-20新增，真实TV周期91分钟
        }
